...
print("gs price in ether: ",gas_price_in_ether)
gas_price_in_dollar=gas_price_in_ether*3102.35
print("gas price in dollar: ", gas_price_in_dollar)

Block_data=web3.eth.getBlock(135246)

latest_transaction=Block_data['transactions'][-1].hex()
print('trasaction hash data: ', latest_transaction)
...
print("Gas limit: ",transaction_detail['gas'])